...
In Google Sheets, you can use the **[IMPORTHTML](https://support.google.com/docs/answer/3093339?hl=en)** function to import the data from an HTML table (or list) on a web page. This function is similar to the IMPORTRANGE function. Refer to the Google Help Center's IMPORTHTML
